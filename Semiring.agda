...
monotone* levelSemiring PrivPub (Refl Public) = {!!}
monotone* levelSemiring PrivPub (Refl Private) = {!!}
monotone* levelSemiring PrivPub (Refl Dunno) = {!!}
monotone* levelSemiring PrivPub (Refl Unused) = {!!}
...
monotone* levelSemiring (Refl r) 0Pub = {!!}
monotone* levelSemiring (Refl r) 0Priv = {!!}
monotone* levelSemiring (Refl r) PrivPub = {!!}
monotone* levelSemiring (Refl r) 0Dunno = {!!}
monotone* levelSemiring (Refl r) PrivDunno = {!!}
monotone* levelSemiring (Refl r) (Refl _) = {!!}
