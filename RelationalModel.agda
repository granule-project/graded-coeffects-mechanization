...
... | prodInterpBi .va .va' .vb .vb' inner1 inner2 =
  ...
  where
    ...
    goal1 : ⟦ Box r A ⟧e adv (Promote va) (Promote va')
    goal1 v0 v0' v0redux v0'redux
      rewrite determinism {_} {Promote va} {v0} v0redux (valuesDontReduce (promoteValue va))
            | determinism {_} {Promote va'} {v0'} v0'redux (valuesDontReduce (promoteValue va')) = boxInterpBiobs pre va va' inner1'
    ...
    goal2 : ⟦ Box r B ⟧e adv (Promote vb) (Promote vb')
    goal2 v0 v0' v0redux v0'redux
...
... | prodInterpV .va .vb inner1 inner2 | prodInterpV .va' .vb' inner1' inner2' =
  ...
  where
    ...
    goal1 v0 v0' v0redux v0'redux
      rewrite determinism {_} {Promote va} {v0} v0redux (valuesDontReduce (promoteValue va))
            | determinism {_} {Promote va'} {v0'} v0'redux (valuesDontReduce (promoteValue va')) =
            boxInterpBiunobs pre va va' (inner1a , inner1a')

    goal2 : ⟦ Box r B ⟧e adv (Promote vb) (Promote vb')
    goal2 v0 v0' v0redux v0'redux
      rewrite determinism {_} {Promote vb} {v0} v0redux (valuesDontReduce (promoteValue vb))
            | determinism {_} {Promote vb'} {v0'} v0'redux (valuesDontReduce (promoteValue vb')) =
