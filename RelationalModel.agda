...
-- Non-interference
nonInterfSpecialised : {{R : Semiring}} {{R' : NonInterferingSemiring R}} {A : Type} {e : Term} {r s : grade} {pre : r ≤ s}
...
nonInterfSpecialised {{_}} {{_}} {A} {e} {r} {s} {pre} typing v1 v2 v1typing v2typing isvalv1 isvalv2 with
