...
-- ginterp with ((Ext Γ1 (Grad A r1)) ++ (r · (Ext Γ2 (Grad A' r2)))) | ginterp
--    splitContext1 {_} {v1 ∷ γ1} {v2 ∷ γ2} {Ext Γ1 (Grad A r1)} {Ext Γ2 (Grad A' r2)} ginterp | Ext g (Grad A₁ r) | arg , rest =
--      {!!} , {!splitContext1 {?} {γ1} {γ2} {Γ1} {Γ2} !}
